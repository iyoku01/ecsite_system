...
INSERT INTO `product_mst` (`product_id`, `product_name`, `price`, `info`, `stocks`, `comment`, `hard_id`, `category_id`, `ave_eval`, `review_count`) VALUES (9, 'ゼルダの伝説 ブレス オブ ザ ワイルド', 6980, 'ハイラル王国は遙か昔、神話の時代から、何度も何度も魔王ガノンの厄災に見舞われてきた。その度に退魔の力を持つ騎士と、聖なる力を持つ姫によって封印されてきた。', 999, 'やって損などなし！', 1, 1, 5, 32);
INSERT INTO `product_mst` (`product_id`, `product_name`, `price`, `info`, `stocks`, `comment`, `hard_id`, `category_id`, `ave_eval`, `review_count`) VALUES (10, 'バイオハザード7 (BIO HAZARD 7)', 7990, 'すべては“恐怖"のために。新生するバイオハザード7。', 999, 'ちびります・・・', 2, 5, 3, 11);
