...
INSERT INTO `product_mst` (`product_id`, `product_name`, `price`, `info`, `stocks`, `comment`, `hard_id`, `category_id`, `ave_eval`, `review_count`) VALUES (2, 'ファイナルファンタジー15(FINALFANTASY15)', 8980, 'どこまでも広がる世界、どこまでも行ける世界：　広大な世界を自由に動き回って探索、攻略ができる「オープンワールド」形式を採用。時間経過、天候の変化により、世界の状況はリアルタイムで変化す る。笑い声が響く街並み、鳥たちが舞う草原、鬱蒼とした森、深く暗い洞窟──。目的地への移動も、世界の探索も全てプレイヤーの意志に委ねられます。', 999, '圧倒的なグラフィック！そして音楽はとても素晴らしいです。でも、でも・・・肝心なシナリオ部分が今回省略されている部分が多く、有料のDLCを購入してようやく話が繋がった感じ・・・DLC前提ではなく、製品版できちんとストーリーをすべて分かるようにしてほしかったです・・・(ﾟДﾟ)', 2, 2, 4, 2);
