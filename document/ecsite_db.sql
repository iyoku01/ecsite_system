...
INSERT INTO `product_mst` (`product_id`, `product_name`, `price`, `info`, `stocks`, `comment`, `hard_id`, `category_id`, `ave_eval`, `review_count`) VALUES (2, 'FINAL FANTASY 15', 8980, 'どこまでも広がる世界、どこまでも行ける世界：　広大な世界を自由に動き回って探索、攻略ができる「オープンワールド」形式を採用。時間経過、天候の変化により、世界の状況はリアルタイムで変化す る。笑い声が響く街並み、鳥たちが舞う草原、鬱蒼とした森、深く暗い洞窟──。目的地への移動も、世界の探索も全てプレイヤーの意志に委ねられます。', 999, '圧倒的なグラフィック！そして音楽はとても素晴らしいです。でも、でも・・・肝心なシナリオ部分が今回省略されている部分が多く、有料のDLCを購入してようやく話が繋がった感じ・・・DLC前提ではなく、製品版できちんとストーリーをすべて分かるようにしてほしかったです・・・(ﾟДﾟ)', 2, 2, 2, 12);
...
INSERT INTO `product_mst` (`product_id`, `product_name`, `price`, `info`, `stocks`, `comment`, `hard_id`, `category_id`, `ave_eval`, `review_count`) VALUES (5, 'Xenoblade2', 7980, '果てしなく広がる雲海の上、超巨大生物「巨神獣(アルス)」が行きかう世界「アルスト」。', 999, 'ゼノギアス、セノサーガに続くゼノブレイドシリーズの第2弾！グラフィックはFF等と比較すると見劣りする部分はありますが、これだけの広大な世界は逆にFFやDQにはない世界です。ゲームはグラフィックではなく最終的には楽しいかどうかが大事です。しかしゼノギアスは楽しかったなぁ・・・でも人肉缶詰工場は未だにトラウマ・・・', 1, 1, 5, 15);
...
INSERT INTO `product_mst` (`product_id`, `product_name`, `price`, `info`, `stocks`, `comment`, `hard_id`, `category_id`, `ave_eval`, `review_count`) VALUES (8, 'ペルソナ5', 8800, '前作『ペルソナ４』から約8年。｢ペルソナ｣シリーズのナンバリング最新作であるPlayStaion4ソフトウェア『ペルソナ５』が、ついに発売。', 999, '独特な世界観とかデザインがステキな作品です。最近ではFF、ドラクエに次ぐ3作目の大作RPGなんて呼ばれるようにもなって来ました( ^ω^ )！世界での評価も高いようなので、今後のペルソナシリーズにますます期待大です♪', 2, 1, 3, 18);
