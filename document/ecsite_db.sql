...
INSERT INTO `product_mst` (`product_id`, `product_name`, `price`, `info`, `stocks`, `comment`, `hard_id`, `category_id`, `ave_eval`, `review_count`) VALUES (3, 'DRAGON QUEST 11', 7800, '「ドラゴンクエスト」シリーズ11番目となる本編最新作は、シリーズの原点に立ち返り「勇者」の冒険を描いた物語。PlayStation (R) 4、ニンテンドー3DSの2つのプラットフォームで展開される、“懐かしさ"と“新しさ"を兼ね備えた、シリーズの「新たなる原点」となる11番目の冒険、『ドラゴンクエストXI』が、今ここに始まる。', 999, 'アバーーーーーーーーーーーーーンストラーーーーーーーーーーーーーーーーーーーーッシュ(/・ω・)/！！！！', 2, 4, 3, 13);
...
INSERT INTO `product_mst` (`product_id`, `product_name`, `price`, `info`, `stocks`, `comment`, `hard_id`, `category_id`, `ave_eval`, `review_count`) VALUES (5, 'Xenoblade2', 7980, '行こう、楽園へ！', 999, 'ゼノギアスは楽しかったなぁ・・・人肉缶詰工場はトラウマ・・・', 1, 1, 5, 15);
INSERT INTO `product_mst` (`product_id`, `product_name`, `price`, `info`, `stocks`, `comment`, `hard_id`, `category_id`, `ave_eval`, `review_count`) VALUES (6, 'マリオカートデラックス8', 5980, '『マリオカート8』は、任天堂より2014年5月29日に発売されたWii U用ゲームソフト。家庭用向けのマリオカートシリーズとしては8作目にあたる。 ', 999, 'はっきり言おう。私はマリオカートがめちゃくちゃ下手くそなのです・・・', 1, 6, 1, 16);
...
INSERT INTO `product_mst` (`product_id`, `product_name`, `price`, `info`, `stocks`, `comment`, `hard_id`, `category_id`, `ave_eval`, `review_count`) VALUES (8, 'ペルソナ5', 8800, '前作『ペルソナ４』から約8年。｢ペルソナ｣シリーズのナンバリング最新作であるPlayStaion4ソフトウェア『ペルソナ５』が、ついに発売。', 999, '独特な世界観とかデザインとかハマる人にはハマるでしょうねぇ・・・( ^ω^ )', 2, 1, 3, 18);
